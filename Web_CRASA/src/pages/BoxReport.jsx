...
export default function BoxReport() {
        ...
        const datosGenerados = clientes.map((cliente) => {
            ...
            años.forEach((año) => {
                marcas.forEach((marca) => {
                    // Generar cantidad aleatoria de cajas
                    const cantidad = Math.floor(Math.random() * 101)
  ...
  const exportarDatos = (filtrosAplicados) => {
    try {
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "Reporte Cajas")
      ...
      XLSX.writeFile(workbook, `reporte_cajas_${timestamp}.xlsx`)
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="container mx-auto">
        ...
        <Card className="ml-4 mr-4">
          <CardHeader>
            <CardTitle>Cajas por Cliente y Marca</CardTitle>
            <CardDescription>Cantidad de cajas compradas por cada cliente</CardDescription>
          </CardHeader>
          <CardContent>
